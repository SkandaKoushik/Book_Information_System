...
?>
   	<form action="myList.php" method="post">
	   	<table class="table">
			...
			<tr>
				...
				<td><?php echo getPubName($conn, $book['publisherid']); ?></td>
	...
	<br/><br/>
	<a href="checkout.php" class="btn btn-primary">Purchase Books</a> 
	<a href="books.php" class="btn btn-primary"><span class="glyphicon glyphicon-home"></span>&nbsp; Home</a>
<?php
	} else {
